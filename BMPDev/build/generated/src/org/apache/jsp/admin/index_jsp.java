...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 request.setCharacterEncoding("UTF-8"); 
	...
	try {
      ...
      out.write("                    \n");
      out.write("                     <h2 style=\"text-align: center\">จัดการเช่ารถ</h2>\n");
      ...
      out.write("                                    <thead>\n");
      out.write("                                        <tr>\n");
      out.write("                                            <th> <div align=\"center\">HireID </div></th>\n");
...
while((rec!=null) && (rec.next())) { 
      ...
      out.print(rec.getString("HireID"));
      out.write("</div></td>\n");
      ...
      out.write("</td>\n");
      out.write("                                            <td align=\"center\"><a type=\"button\" href=\"view.jsp?CusID=");
      out.print(rec.getString("HireID"));
      out.write("\" class=\"btn btn-primary btn-circle\"><i class=\"glyphicon glyphicon-info-sign\"></i></a></td>\n");
      out.write("                                            <td align=\"center\"><a type=\"button\" href=\"edit.jsp?CusID=");
      out.print(rec.getString("HireID"));
      out.write("\" class=\"btn btn-info btn-circle\"><i class=\"glyphicon glyphicon-edit\"></i></a>                                                \n");
      out.write("                                            <td align=\"center\"><a type=\"button\" onclick=\"del()\" class=\"btn btn-danger btn-circle\"><i class=\"glyphicon glyphicon-trash\"></i></a>\n");
      out.write("                                                <script>\n");
      ...
      out.write(" ?\") == true) \n");
      out.write("                                                        {\n");
      out.write("                                                        javascript:location.href=\"del.jsp?CusID=");
      out.print(rec.getString("HireID"));
      out.write("\"\n");
      out.write("                                                        } \n");
      out.write("                                                }\n");
...
while((rec!=null) && (rec.next())) { 
      ...
      out.write("                    <h2 style=\"text-align: center\">จัดการคืนรถ</h2>\n");
      out.write("                ");
      ...
      out.write("                                    <thead>\n");
      out.write("                                        <tr>\n");
      out.write("                                            <th> <div align=\"center\">StandID </div></th>\n");
      out.write("                                            <th> <div align=\"center\">UserID </div></th>\n");
      out.write("                                            <th> <div align=\"center\">MotorCycleID </div></th>\n");
      out.write("                                            <th> <div align=\"center\">Data </div></th>\n");
      out.write("                                            <th> <div align=\"center\">ExpiredDate </div></th>\n");
...
while((rec!=null) && (rec.next())) { 
      ...
      out.print(rec.getString("ExpiredDate"));
      out.write("</td>\n");
      out.write("                                            <td align=\"center\"><a type=\"button\" href=\"/BMPDev/admin/stand/view.jsp?StandID=");
      out.print(rec.getString("StandID"));
      out.write("\" class=\"btn btn-primary btn-circle\"><i class=\"glyphicon glyphicon-info-sign\"></i></a></td>\n");
      out.write("                                            <td align=\"center\"><a type=\"button\" href=\"/BMPDev/admin/stand/edit.jsp?StandID=");
      out.print(rec.getString("StandID"));
      out.write("\" class=\"btn btn-info btn-circle\"><i class=\"glyphicon glyphicon-edit\"></i></a>                                                \n");
      out.write("                                            <td align=\"center\"><a type=\"button\" onclick=\"del3()\" class=\"btn btn-danger btn-circle\"><i class=\"glyphicon glyphicon-trash\"></i></a>\n");
      out.write("                                                <script>\n");
      out.write("                                                function del3() \n");
      out.write("                                                {\n");
      out.write("                                                        if (confirm(\"จัดการคืนรถ คุณต้องการลบ ");
      out.print(rec.getString("StandID"));
      out.write(" ?\") === true)\n");
      out.write("                                                        {\n");
      out.write("                                                        javascript:location.href=\"/BMPDev/admin/stand/del.jsp?StandID=");
      out.print(rec.getString("StandID"));
      out.write("\"\n");
      out.write("                                                        } \n");
      out.write("                                                }\n");
      ...
      out.write("\n");
      out.write("                             <h2 style=\"text-align: center\">จัดการผู้ใช้</h2>\n");
      out.write("                             <div class=\"panel-heading\"> \n");
      out.write("                                 <button type=\"button\" class=\"btn btn-primary btn-lg btn-block\" onclick=\"document.getElementById('id01').style.display='block'\" style=\"width:auto;\"><i class=\"glyphicon glyphicon-plus\"></i>เพิ่มข้อมูล</button>\n");
      out.write("                             </div>                             \n");
      out.write("                            <div class=\"panel-body\">\n");
      out.write("                            <div class=\"table-responsive\">\n");
      out.write("                                <table class=\"table table-striped table-bordered table-hover\">\n");
      out.write("                                    <thead>\n");
      out.write("                                        <tr>\n");
      out.write("                                            <th width=\"91\"> <div align=\"center\">UserID </div></th>\n");
      out.write("                                            <th width=\"98\"> <div align=\"center\">Username </div></th>\n");
      out.write("                                            <th width=\"198\"> <div align=\"center\">Password </div></th>\n");
      out.write("                                            <th width=\"59\"> <div align=\"center\">Email </div></th>\n");
      out.write("                                            <th width=\"71\"> <div align=\"center\">View </div></th>\n");
      out.write("                                            <th width=\"71\"> <div align=\"center\">Edit </div></th>\n");
...
out.print(configmysql.website);
      ...
      out.write("    </script>\n");
      out.write("\n");
      out.write("<div id=\"id01\" class=\"modal sweet-overlay\" onfocus=\"JavaScript:return null;\">\n");
      out.write("   <form class=\"modal-content animate\" name=\"frmAdd\" method=\"post\" action=\"add.jsp\"  onSubmit=\"JavaScript:return fncSubmit();\">\t\n");
      out.write("        <center>\n");
      out.write("        <div class=\"form-group\">\n");
      out.write("            <input class=\"form-control\" type=\"text\"  name=\"txtCustomerID\" placeholder=\"CustomerID\" id=\"t1\" style=\"width: 90%\">\n");
      out.write("            <input class=\"form-control\" type=\"text\" name=\"txtName\" placeholder=\"Name\" style=\"width: 90%\">\n");
      out.write("            <input class=\"form-control\" type=\"email\" name=\"txtEmail\" placeholder=\" E-mail\" style=\"width: 90%\">\n");
      out.write("            <input class=\"form-control\" type=\"text\" name=\"txtCountryCode\" placeholder=\"CountryCode\" style=\"width: 90%\">\n");
      out.write("            <input class=\"form-control\" type=\"text\" name=\"txtBudget\" placeholder=\"Budget\" style=\"width: 90%\">\n");
      out.write("            <input class=\"form-control\" type=\"text\" name=\"txtUsed\" placeholder=\"Used\" style=\"width: 90%\">\n");
      out.write("            <table border=\"0\">\n");
      out.write("                 <tbody>\n");
      out.write("                    <tr>\n");
      out.write("                        <td><button type=\"button\" class=\"btn btn-danger form-control \" onclick=\"document.getElementById('id01').style.display='none'\"><i class=\"glyphicon glyphicon-remove\"></i> ออก</button></td>\n");
      out.write("                        <td>&nbsp;</td>\n");
      out.write("                        <td><button type=\"submit\" name=\"Submit\" class=\"btn btn-success\"><i class=\"glyphicon glyphicon-ok\"></i> บันทึก</button></td>\n");
      out.write("                    </tr>\n");
      out.write("                </tbody>                \n");
      out.write("            </table>\n");
      out.write("        </div>\n");
