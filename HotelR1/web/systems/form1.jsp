...
<html>
                    ...
                    <div class="panel-body">
                        <div class="row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="col-sm-10">
                                                            <div class="form-group input-group">
                                                                ...
                                                                <input type="text" class="form-control" id="idno" placeholder="กรุณาระบบหมายเลขประจำตัวประชาชน" required="true">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-2">
                                    ...
                                    <div class="panel-body">
                                        <form onsubmit="return false;"name="form1" id="form1"><!--ใช้ ajax ในการบันทึกข้อมูลลูกค้า-->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="guest_idno_input" id="guest_idno_input">
                                            </div>
                                            <div class="form-group">
                                                <label>อีเมล์*:</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="guest_phone_input" id="guest_phone_input">
                                            </div>
                                            <div class="form-group">
                                                <label>ที่อยู่:</label>
                            ...
                            <div class="col-lg-12 text-center" id="wait_email">
                                ...
                                <span class="btn btn-info"><input type="checkbox" name="sendemail" id="sendemail"/>ส่ง E-mail</span>  
    ...
    <script>
        ...
        function search_guest() {
            ...
            if (idno === "") {
                alert('กรุณากรอกข้อมูลเพื่อใช้ในการค้นหาข้อูลลูกค้า');
                get('idno').focus();
                return false;
            }
        ...
        function SendEmail() {
            ...
            $.ajax({
                type: "GET",
                url: "../ajax/send_email.jsp?email=" + email,
                dataType: "html",
                success: function (data) {
